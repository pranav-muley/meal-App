...
var wel = document.getElementById("welcome-snip");




//create a list from a local Storage...
...
//hide welcome note function after click on input
function hide(){
    wel.hidden = true;
}
...
function showMealList() {
    ...
    meals.then(data => {
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center" ">
                            ...
                            <div class="heading2 mb-4 lead white">
                                Sorry For Inconviencement,item you're looking for is currently unavailable.....
                            </div>
                        </div>
                    </div>
                </div>
        ...
        // console.log("found inside a Show meal list");
...
async function showMealDetails(id) {
    ...
    document.getElementById("recipe-list").innerHTML = htmlmealDetail;
